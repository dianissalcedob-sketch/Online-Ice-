...
Detectar patrones que permitan predecir si un videojuego tendrá éxito, considerando variables como:
...
Este análisis permite identificar proyectos prometedores y mejorar la planificación de marketing.

---

## 📅 Contexto del análisis

Los datos disponibles abarcan hasta el año 2016.

Se asume el escenario de diciembre de 2016, donde el objetivo es preparar una estrategia para el año 2017.

El enfoque del proyecto no es únicamente predictivo, sino también formativo, permitiendo desarrollar habilidades clave en análisis de datos aplicados a negocio.
...
* Identificar videojuegos con alto potencial comercial
